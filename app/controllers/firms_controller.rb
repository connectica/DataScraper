...
#=> "Let It Happen"
  ...
  def json2
  	...
  	orgnr = params[:id]
  	url = "http://1881dm.giantleap.no/dmserver/api/v1/search/details/100954965S1?client-id=64E05B54-749B-452A-8292-74BC92E16EC9"
  	response = HTTParty.get(url)
		json = JSON.parse(response.body)
  ...
  def scan
  		...
  		#http://1881dm.giantleap.no/dmserver/api/v1/search/freetext?q=6536547&lat=13.731043&lon=100.560560&client-id=64E05B54-749B-452A-8292-74BC92E16EC9
			...
			firma = Firm.where(opplysningen: '').limit(10000000)
		 	firma.each do |f|
				Opplysningen1881Worker.perform_async(f.orgnr,34)
			end
	end
